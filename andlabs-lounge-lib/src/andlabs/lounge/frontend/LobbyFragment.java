...
public class LobbyFragment extends Fragment implements OnChildClickListener, LoungeLobbyCallback {
	...
	public View onCreateView(final LayoutInflater lI, ViewGroup p, Bundle b) {
	    ...
	    LoungeLobbyController.getInstance().registerCallback(this);
